...
from app.api.deps import get_current_user, get_session, get_user_repository
...
mediator.register_handler(GetActiveUsersQuery, GetActiveUsersHandler(repository=get_user_repository()))
